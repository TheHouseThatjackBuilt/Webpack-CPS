...
export const callbackButton = document.querySelectorAll('.button__call');
export const sidebarButton = document.querySelector('.button__menu');


export const feedbackWindow = document.querySelector('.feedback');
export const callbackWindow = document.querySelector('.callback');
export const sidebarWindow = document.querySelector('.sidebar');
// оверфлоу
export const mainBody = document.body;
